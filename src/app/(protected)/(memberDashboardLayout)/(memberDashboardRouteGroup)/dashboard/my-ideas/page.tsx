            ...
            return (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {idea.status === "REJECTED" && (
                    <div className="bg-gradient-to-br from-red-50 to-red-50/50 dark:from-red-900/30 dark:to-red-900/10 border-l-4 border-red-500 dark:border-red-600 rounded-lg p-4 mb-4 space-y-2">
                      ...
                      {idea.feedback ? (
                        <p className="text-sm text-red-700 dark:text-red-200 leading-relaxed pl-6">
                          {idea.feedback}
                        </p>
                      ) : (
                        <p className="text-sm text-red-600 dark:text-red-300 italic pl-6">
                          No feedback provided. Please contact admin for details.
                        </p>
                      )}
                      <div className="pt-2 pl-6 text-xs text-red-600 dark:text-red-300 space-y-1">
                        <p>💡 <strong>Next Steps:</strong> Review the feedback, make improvements, and resubmit your idea.</p>
                      </div>
                    </div>
                  )}
